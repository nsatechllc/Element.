...
pub struct ClientConfig {
    ...
    /// Experimental: Require a post-quantum KEM (Kyber) key exchange.
    /// If true, the client will abort the handshake if a non-PQ group is
    /// negotiated while Kyber (or a hybrid containing Kyber) was offered.
